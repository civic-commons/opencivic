...
hide($content['links']);
?>
<article id="node-<?php print $node->nid; ?>" class="<?php if ($view_mode != 'custom_title_link') { print $classes; } ?> clearfix"<?php print $attributes; ?>>
  <?php print render($title_prefix); ?>

  <?php if ($view_mode != 'custom_title_link' && $title && !$page): ?>
